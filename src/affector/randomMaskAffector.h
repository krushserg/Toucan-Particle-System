...
class RandomMaskAffector : public Affector
{
public:

    RandomMaskAffector(shared_ptr<Randomizer> number_randomizer = make_shared<UniformRandomizer>())\
          :_number_randomizer(number_randomizer)
    {

    }
    void addMask(size_t mask)
    {
        _data.push_back(mask);
    }
